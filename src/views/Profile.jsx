      ...
      <section className="lg:w-full lg:flex lg:flex-row object-right lg:items-end ">
        ...
        <section className="lg:w-1/4 w-full items-center justify-center">
          <button
            ...
            className="flex hover:scale-105 hover:shadow-md w-48 flex justify-center bg-primary text-white font-bold px-3 py-2 rounded-sm mt-4 mb-4 cursor-pointer rounded-xl h-10 "
          >
