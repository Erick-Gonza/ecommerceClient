...
import { HiOutlineTrash, HiOutlinePencil, HiFilter, HiOutlinePlusCircle } from "react-icons/hi";
        ...
        <div className='my-3 flex justify-center text-center'>
          <table className='w-full'>
            ...
            {products.map((product,key)=>{
              return(
                <tr key={key} className="text-center border-b-2 hover:bg-neutral-200 ">
                  <td>{product.id}</td>
                  <td>{product.name}</td>
                  <td>Category</td>
