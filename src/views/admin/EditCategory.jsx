...
import { 
  ...
  useUpdateCategoryMutation } from '../../store/service/category/categoryService'
        ...
        <div className='flex flex-row h-1/2 w-full justify-evenly'>
            <table className='border w-full'>
                ...
                {categories.map((category,key)=>{
                  return(
                    <tr key={key} className='hover:bg-gray-variant hover:bg-opacity-50'>
            ...
            <input
              ...
              className="border-2 w-full p-2 rounded-md placeholder-gray shadow-md"
            />
            <button className='w-full text-center mt-2 py-2 border rounded bg-primary text-white'>Confirm</button>
          </form>
            </div>
            </div>

      <div className="flex flex-col md:flex-row justify-between hidden ">
        <div className='my-3'>
