...
export const Nav = () => {
  return (
    <section className="w-full bg-primary">
      <nav className="w-full px-4 py-3 flex text-white">
        <section className="w-auto">
          <h2>Logo</h2>
        </section>

        <section className="hidden md:block relative rounded-md mx-3">
        ...
        <section className="hidden md:flex justify-center items-center gap-8 w-full text-sm text-white">
          ...
          <Link className="flex flex-row" to="/favorites">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
